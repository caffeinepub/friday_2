...
import type { UserPreferences as _UserPreferences, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getConversationHistory(arg0: bigint, arg1: bigint): Promise<Array<Message>> {
        if (this.processError) {
            try {
    ...
    async saveMessage(arg0: Message): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_opt_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_UserPreferences]): UserPreferences | null {
    return value.length === 0 ? null : value[0];
}
